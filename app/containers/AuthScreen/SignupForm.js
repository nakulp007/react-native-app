...
export default class SignupForm extends Component {
  static propTypes = {
    ...
    onConfirmSignupLinkPress: PropTypes.func.isRequired,
  }
  ...
  render () {
    ...
    const { isLoading, onLoginLinkPress, onConfirmSignupLinkPress, onSignupPress } = this.props
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.footer}>
          ...
          <Text
            ref={(ref) => this.linkRef = ref}
            style={styles.confirmEmailLink}
            onPress={onConfirmSignupLinkPress}
            animation={'fadeIn'}
            duration={600}
            delay={400}
          >
